...
namespace MSPB.MSPB004.pdf
{
    ...
    class clsYupackSendingSlip
    {
        ...
        {
            string outPath = Path.Combine(ConfigurationManager.AppSettings["MSPB004_YUPACK_LIST_OUTPUT_PATH"], this.SHIPPING_DATE);
            string outFile = Path.Combine(outPath, string.Format(ConfigurationManager.AppSettings["MSPB004_YUPACK_LIST_FILE"], this.SHIPPING_DATE, output_type,DateTime.Now.ToString("HHmmss")));
            ...
            using(PdfCreator pdf = new PdfCreator(outFile, ConfigurationManager.AppSettings["MSPB004_YUPACK_LIST_OVL"]))
            {
                int keyCount = 0;
                int dataCount = 0;
        ...
        private void writeHeader(PdfCreator pdf,string shipDate,int pageNo, int max_page)
        {
            ...
            pdf.WriteTextRegion(new RectangleF(
                ...
                ConfigurationManager.AppSettings["MSPB004_YUPACK_SEND_DEPT"],
        ...
        private void getPosInfo()
        {
            ...
            clsPdfPosition posInfo = new clsPdfPosition(ConfigurationManager.AppSettings["MSPB004_YUPACK_SLIP_POS_FILE"], "Setting/List");
